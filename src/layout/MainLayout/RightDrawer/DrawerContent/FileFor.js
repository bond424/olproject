...
export default function GmailTreeView() {
    return (
        ...
        >
            <StyledTreeItem nodeId="1" labelText="시도" labelIcon={MailIcon} />
            <StyledTreeItem nodeId="2" labelText="시도" labelIcon={DeleteIcon} />
            <StyledTreeItem nodeId="3" labelText="시도" labelIcon={Label}>
                <StyledTreeItem
                    nodeId="5"
                    labelText="Social"
